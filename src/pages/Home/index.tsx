              ...
              <div className="relative -left-[125px] top-[125px] grid grid-cols-[270px_1fr] gap-20 pt-[70px] px-[130px] h-[540px] bg-mountains-blue ">
                ...
                <div>
                  ...
                  <p className="text-2xl mt-6 mb-10 w-[780px]">
                    Book flights, hotels, trains & rental cars anywhewre in the
                    word in just seconds. Get real-time flight updates, travel
                    info, exclusive details, and 30% more Trip Coins on the app!
                  </p>
                  {/* Parte baja */}
